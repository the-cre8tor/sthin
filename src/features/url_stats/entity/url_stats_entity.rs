...
use crate::features::url_stats::{error::UrlStatsError, model::UrlStats};
...
impl UrlStatsEntity {
    pub fn from_domain(stats: UrlStats) -> Self {
        Self {
    ...
    pub fn to_domain(&self) -> Result<UrlStats, UrlStatsError> {
        Ok(UrlStats {
            id: Some(self.id),
            url_id: self.url_id,
